...
define("EMAIL", 'info@newcrestassets.com');
...
function sendInterestEmail($userEmail, $username, $plan, $amount){
    ...
    <div style="background: white; width: 95vw; max-width: 600px; height: 430px; margin: 0px auto 0px auto">
        <div style="height: 30px;">
            <h1 style="margin: 0px ; width: 90%; padding-top: 0px; color: white; "><img src="https://newcrestassets.com/img/logo.png" width="130px" style=" padding: 10px;"></h1>
        </div>
        
        <div style=" padding: 40px 20px 10px 20px; width: 90%; margin: 0px">
            
            <p>Hello '. $username . ',</p>
            <p>This is to notify you of a new return on investment (ROI), please log into your account to confirm.</p>
    ...
    ->setFrom('info@newcrestassets.com', 'Newcrest Assets Management')
    ->setTo([$userEmail])
