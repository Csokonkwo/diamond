    ...
    <footer>
        <div class="footer-top">
            <div class="container">
                ...
                <p><a href="<?php echo BASE_URL.'/about.php'?>"><i class="fa fa-bullhorn"></i> Request a quote  <span>Get all the information</span></a></p>
            </div>
        </div>
        ...
        <div class="footer-bottom">
            <div class="container clearfix">
                ...
                <p> <?php echo $companyName; ?> &copy; 2009-2020, All Rights reserved.</p>
            </div>
        </div>
