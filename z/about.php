        ...
        <div class="about-other">
            <div class="container">
                <div class="left">
                    ...
                    <p>Welcome to the website of <?php echo $companyName;?>. Our investment platform is a product of careful preparation and fruitful work of experts in the field of cryptocurrency mining, highly profitable trade in cryptocurrencies and foreign exchanges. Using modern methods of doing business and a personal approach to each client, we offer a unique investment model to investors who want to use cryptocurrencies not only as a method of payment, but also as a reliable source of stable income. <?php echo $companyName;?> business uses improved mining equipments and antminers at the most stable markets, which minimizes the risks of financial loss to clients and guarantees them a fixed income accrued every calendar day.</p>
