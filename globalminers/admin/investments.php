                        ...
                        <?php $userT = selectOne('users', ['id' => $investment['user_idd']]); ?>
                            ...
                            <?php
                                $hourz = 0;
                                    ...
                                    if($investment['currency'] == 'bronze'){
                                        $hourz = 172800;
                                    }

                                    if($investment['currency'] == 'silver'){
                                        $hourz = 259200;
                                    }

                                    if($investment['currency'] == 'gold'){
                                        $hourz = 259200;
                                    }
                            ...
                            <?php else:?>
                            <td><?php echo $timeLeft + 6 . 'hour'. $ss ; ?></td>
                            <?php endif; ?>


                            <?php if($investment['status'] != 'Completed'): ?>
                            <td><a href="investments.php?status=Confirmed&t_id=<?php echo $investment['id']?>" >Confirm</a></td>
                            <td><a href="investments.php?amount=<?php echo $investment['amount']; ?>&t_id=<?php echo $investment['id']?>&user_idd=<?php echo $investment['user_idd']?>&currency=<?php echo $investment['currency']?>"> Pay</a></td>
                            <?php endif; ?>
                            <td><a href="investments.php?status=Cancelled&t_id=<?php echo $investment['id']?>">Cancel</a></td>                       
