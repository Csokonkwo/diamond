...
define("EMAIL", 'admin@globalminers.uk');
define("PASSWORD", 'global333');

require_once 'vendor/autoload.php';

// Create the Transport
$transport = (new Swift_SmtpTransport('globalminers.uk', 465, 'ssl'))
...
function sendPasswordResetLink($userEmail, $token){
    ...
    <div style="background: white; width: 95vw; max-width: 600px; height: 370px; margin: 10px auto 50px auto">
        <div style="height: 60px;">
            <h1 style="margin: 0px auto; width: 90%; text-align: center; padding-top: 20px; color: white; "><img src="https://globalminers.uk/img/logo.png" width="120px"></h1>
        </div>
        ...
        <div style=" padding: 10px 20px; text-align: center; width: 90%; margin: auto;">
            ...
            <a href="https://globalminers.uk/register/signin.php?password-token=' . $token. '" style="color: white; background: #1b4a40; padding: 15px 20px; border-radius: 5px; text-decoration: none; display: block; margin-top: 25px;">Recover Password</a>
    ...
    <div style=" width: 90vw; max-width: 600px; text-align: center; margin:0px auto">
        ...
        <p style="margin-top: 0px;">
            ...
            <a href="globalminers.uk">
                <i class="fab fa-whatsapp"></i>
            </a>
        </p>
        <p style="padding-bottom: 20px; margin-bottom: 30px;">Copyright &copy; Globalminers, All rights reserved.</p>
    </div>
...
function sendCashoutConfirm($userEmail, $username, $amount, $hash){
    ...
    <div style="background: white; width: 95vw; max-width: 600px; height: 220px; margin: 0px auto 0px auto">
        <div style="height: 30px;">
            <h1 style="margin: 0px auto; width: 90%; text-align: center; padding-top: 0px; color: white; "><img src="https://globalminers.uk/img/logo.png" width="120px"></h1>
        </div>
        ...
        <img height="" style="display: block;  width: 95vw; max-width: 600px; margin: auto" src="https://globalminers.uk/img/hero_2.jpg">
...
function sendMessage($userEmail, $fullname, $email, $message){
    ...
    <div style=" width: 90vw; max-width: 600px; text-align: center; margin:0px auto">
        <h3 style="font-family: "Merriweather"">Sent from Globalminers</h3>
...
function sendVerification($userEmail, $username){
    ...
    <div style="background: white; width: 95vw; max-width: 600px; height: 170px; margin: 0px auto 0px auto">
        ...
        <div style=" padding: 0px 20px; text-align: center; width: 90%; margin: auto;">
            ...
            <p>Hello '. $username . ', You have sucessfully created a Globalminers account, Please do well to deposit and stand a chance to enjoy good returns from your investments. Thank you.</p>
