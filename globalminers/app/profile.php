...
<head>
    ...
    <title>Globalminers/Profile</title>
        ...
        <?php include("header.php") ?> 
            ...
            <div class="dashboard-middle profile">
                <div class="right">
                    ...
                    <p>Referrer Name <span><?php $reff = selectOne('users', ['id' => $_SESSION["referrer_id"]]); echo $reff['username']; ?></span></p>
                    <p>Referral Link<span>https://globalminers.uk/register/signup.php?ref=<?php echo $_SESSION['id'] ?></span></p>
