      ...
      >
        ...
        <div class="secu">
            <div class="container">
                ...
                <p>
                    The combination of progressive thinking, the talent of Mr. Smith as both a leader and a business mentor, creates an incredibly fruitful and protected environment for the development of productive and mutually beneficial relations between <?php echo $companyRealName ?> and its partners. The main underlying factor of such a relationship was the fact that  <?php echo $companyRealName ?> takes its transparency and information accessibility very seriously, which characterizes the prospects and volatility of the company's relationship with partners in the best possible way. We value the trust of customers and are always open both for constructive dialogue and for commercial cooperation based on legal and licensed business activities of the company.
                </p>
            </div>
        </div>
