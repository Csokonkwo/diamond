        ...
        <div class="terms">
            ...
            <div class="container">
                <div class="box">
                    ...
                    <p><?php echo $companyRealName;  ?>offers Investment services, Financial Planning and Advice, Retirement Plans, Wealth Management Services, Trading and Brokerage services, and a wide range of other local & international investment services, including investment access to digital real estate known as the Metaverse, an industry that has grown by 500% in the past year.</p>
                    <p><?php echo $companyRealName;  ?> has worked in our clients’ best interests by thinking and acting independently rather than following outdated industry practices. <br> Our personalized approach, our total commitment to serving our clients and our investing experience make us unique in our industry. That’s why <?php echo $companyRealName;  ?> currently manages $12 billion* for investors worldwide and helps over 20,000 clients* meet their financial goals.</p>
                    
                    <br><h3>Our Features</h3>
