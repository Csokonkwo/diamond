...
define("EMAIL", 'admin@diamondassetsventures.com');
define("PASSWORD", 'goodbay//');

require_once 'vendor/autoload.php';

// Create the Transport
$transport = (new Swift_SmtpTransport('diamondassetsventures.com', 465, 'ssl'))
...
function sendPasswordResetLink($userEmail, $token){
    ...
    <div style="background: white; width: 95vw; max-width: 600px; height: 300px; margin: 10px auto 50px auto">
        <div style="height: 60px;">
            <h1 style="margin: 0px auto; width: 90%; text-align: center; padding-top: 20px; color: white; "><img src="https://diamondassetsventures.com/img/logo.png" width="120px"></h1>
        </div>
        ...
        <div style=" padding: 10px 20px; text-align: center; width: 90%; margin: auto;">
            ...
            <a href="https://diamondassetsventures.com/register/signin.php?password-token=' . $token. '"style="color: white; background: #003b65; padding: 15px 20px; border-radius: 5px; text-decoration: none; display: block; margin-top: 25px;"> Change Password </a>
    ...
    <div style=" width: 90vw; max-width: 600px; text-align: center; margin:0px auto">
        ...
        <p style="padding-bottom: 20px; margin-bottom: 30px;">Copyright &copy; Diamond Assets Ventures, All rights reserved.</p>
    </div>
    ...
    //$from = array('admin@diamondassetsventures.com');
    ->setFrom('admin@diamondassetsventures.com', 'Diamond Assets Ventures')
    ->setTo([$userEmail])
...
function sendCashoutConfirm($userEmail, $username, $amount, $hash){
    ...
    <div style="background: white; width: 95vw; max-width: 600px; height: 220px; margin: 0px auto 0px auto">
        <div style="height: 30px;">
            <h1 style="margin: 0px auto; width: 90%; text-align: center; padding-top: 0px; color: white; "><img src="https://diamondassetsventures.com/img/logo.png" width="120px"></h1>
        </div>
        ...
        <img height="" style="display: block;  width: 95vw; max-width: 600px; margin: auto" src="https://diamondassetsventures.com/img/image1.jpg">
...
function sendVerification($userEmail, $username, $token){
    ...
    <div style="background: white; width: 95vw; max-width: 700px; height: max-content; margin: 0px auto; padding:0px 0px 10px 0px" >
        <div style="height: 30px;">
            <h1 style="margin: 0px\; width: 95%; text-align: left; padding-top: 0px; color: white; "><img src="https://diamondassetsventures.com/img/logo.png" width="130px" style=" padding: 10px;"></h1>
        </div>
        
        <div style=" padding: 30px 0px 0px 0px; text-align: left; width: 90%; font-size: 1em; margin: auto;">
            
            <p>Hello '. $username . '! <br>
                I am very happy to Welcome you on board with Diamond Assets Ventures. <br>
                You joined thousands of Investors who are already skyrocketing their Capital with Diamond Assets Ventures by Investing in our packages. <br> <br>
                ...
                <a href="https://diamondassetsventures.com/register/signin.php?token=' . $token. '" style="color: white; background: #003b65; padding: 15px 20px; border-radius: 5px; text-align: center;text-decoration: none; display: block; margin-top: 25px; font-family: lora, Merriweather">Start Verification</a>
        ...
        <img height="" style="display: block;  width: 95vw; max-width: 700px; margin: auto" src="https://diamondassetsventures.com/img/image1.jpg">
...
function emailUsers($userEmail, $username, $userMessage, $subject){
    ...
    <head>
        <meta charset="UTF-8">
        <title>Diamond Assets Ventures</title>
...
function loan($userEmail, $fullname, $email, $message){
    ...
    <div style=" width: 90vw; max-width: 600px; text-align: center; margin:0px auto">
        <h3 style="font-family: "Merriweather"">Sent from Diamond Assets Ventures</h3>
    ...
    ->setFrom('info@metareservegroup.com', 'Diamond Assets Ventures')
    ->setTo([$userEmail])
    ->setBody($body, 'text/html')
    ;
