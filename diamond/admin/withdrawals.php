                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <?php $userT = selectOne('users', ['id' => $withdrawal['user_id']]); ?>
                            ...
                            <td><a href="withdrawals.php?status=3&t_id=<?php echo $withdrawal['id']?>&u_id=<?php echo $withdrawal['user_id'] ?>&a_id=<?php echo $withdrawal['amount'] ?>"> Paid</a></td>
                            <?php endif; ?>
                            <td><a href="withdrawals.php?status=0&t_id=<?php echo $withdrawal['id']?>">Cancel</a></td>                       
