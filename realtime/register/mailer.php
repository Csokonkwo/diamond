...
define("EMAIL", 'admin@realtimefinanceltd.com');
define("PASSWORD", 'scantynation');
 
require_once 'vendor/autoload.php';

// Create the Transport
$transport = (new Swift_SmtpTransport('realtimefinanceltd.com', 465, 'ssl'))
...
function sendPasswordResetLink($userEmail, $token){
    ...
    <div style="background: white; width: 95vw; max-width: 600px; height: 300px; margin: 10px auto 50px auto">
        <div style="height: 60px;">
            <h1 style="margin: 0px auto; width: 90%; text-align: center; padding-top: 20px; color: white; "><img src="https://realtimefinanceltd.com/img/logo.png" width="120px"></h1>
        </div>
        ...
        <div style=" padding: 10px 20px; text-align: center; width: 90%; margin: auto;">
            ...
            <a href="https://realtimefinanceltd.com/register/signin.php?password-token=' . $token. '"style="color: white; background: green; padding: 15px 20px; border-radius: 5px; text-decoration: none; display: block; margin-top: 25px;"> Recover Password </a>
    ...
    <div style=" width: 90vw; max-width: 600px; text-align: center; margin:0px auto">
        ...
        <p style="padding-bottom: 20px; margin-bottom: 30px;">Copyright &copy; Realtime Finance Ltd, All rights reserved.</p>
    </div>
    ...
    //$from = array('admin@realtimefinanceltd.com');
    ->setFrom('admin@realtimefinanceltd.com', 'Realtime Finance Ltd')
    ->setTo([$userEmail])
...
function sendCashoutConfirm($userEmail, $username, $amount, $hash){
    ...
    <div style="background: white; width: 95vw; max-width: 600px; height: 220px; margin: 0px auto 0px auto">
        <div style="height: 30px;">
            <h1 style="margin: 0px auto; width: 90%; text-align: center; padding-top: 0px; color: white; "><img src="https://realtimefinanceltd.com/img/logo.png" width="120px"></h1>
        </div>
        ...
        <img height="" style="display: block;  width: 95vw; max-width: 600px; margin: auto" src="https://realtimefinanceltd.com/img/hero_1.jpg">
...
function sendVerification($userEmail, $username, $password){
    ...
    <div style="background: white; width: 95vw; max-width: 600px; height: 330px; margin: 0px">
        <div style="height: 30px;">
            <h1 style="margin: 0px\; width: 90%; text-align: left; padding-top: 0px; color: white; "><img src="https://realtimefinanceltd.com/img/logo.png" width="130px" style=" padding: 10px;"></h1>
        </div>
...
function sendMessage($userEmail, $fullname, $email, $message){
    ...
    <div style=" width: 90vw; max-width: 600px; text-align: center; margin:0px auto">
        <h3 style="font-family: "Merriweather"">Sent from realtimefinanceltd</h3>
...
function sendNFP($userEmail, $username, $amount, $date){
    ...
    <div style="background: white; width: 95vw; max-width: 600px; height: 430px; margin: 0px auto 0px auto">
        <div style="height: 30px;">
            <h1 style="margin: 0px ; width: 90%; padding-top: 0px; color: white; "><img src="https://realtimefinanceltd.com/img/logo.png" width="130px" style=" padding: 10px;"></h1>
        </div>
