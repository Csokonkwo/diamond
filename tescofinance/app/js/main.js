...
function showWallet(){
    ...
    if(method.value == 'bitcoin'){
        ...
        address.innerHTML = 'Deposit to : <br> <input id="btcAdd" value ="bc1q6r335rzgcjqwzdjfgz7wdast3gmqrd80lzwdlj"> <br> <a onclick="copyBtc()"> Copy </a> <br> <br> '
    }
...
function showDepWallet(){
    ...
    if(method.value == 'bitcoin'){
        address.style.display = "block"
        address.innerHTML = 'Send Bitcoin to : <br> <input id="btcAdd" value ="bc1q6r335rzgcjqwzdjfgz7wdast3gmqrd80lzwdlj"> <br> <a onclick="copyBtc()"> Copy </a> <br> <br> '
    }
