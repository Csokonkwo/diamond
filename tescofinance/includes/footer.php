<footer>
        <div class="top">
            <img style="background: white" src="<?php echo BASE_URL . '/img/icon.png' ?>">
        ...
        <div class="middle">
            <div class="wrapper">
                ...
                <div class="box">
                    <h3>Transfers</h3>
                    <ul>
                        <li><a href="<?php echo BASE_URL . '/' ?>">Western Union</a></li>
                        <li><a href="<?php echo BASE_URL . '/' ?>">Ria Money Transfer</a></li>
                        <li><a href="<?php echo BASE_URL . '/' ?>">MoneyGram</a></li>
                    </ul>
                </div>
