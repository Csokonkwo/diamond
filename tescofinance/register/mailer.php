...
define("EMAIL", 'admin@tescofinancemgt.com');
define("PASSWORD", 'telecom///');

require_once 'vendor/autoload.php';

// Create the Transport
$transport = (new Swift_SmtpTransport('tescofinancemgt.com', 465, 'ssl'))
...
function sendPasswordResetLink($userEmail, $token){
    ...
    <div style="background: white; width: 95vw; max-width: 600px; height: 300px; margin: 10px auto 50px auto">
        <div style="height: 60px;">
            <h1 style="margin: 0px auto; width: 90%; text-align: center; padding-top: 20px; color: white; "><img src="https://tescofinancemgt.com/img/logo.png" width="120px"></h1>
        </div>
        ...
        <div style=" padding: 10px 20px; text-align: center; width: 90%; margin: auto;">
            ...
            <a href="https://tescofinancemgt.com/register/signin.php?password-token=' . $token. '"style="color: white; background: #003b65; padding: 15px 20px; border-radius: 5px; text-decoration: none; display: block; margin-top: 25px;"> Change Password </a>
    ...
    <div style=" width: 90vw; max-width: 600px; text-align: center; margin:0px auto">
        ...
        <p style="padding-bottom: 20px; margin-bottom: 30px;">Copyright &copy; Tesco Finance Management, All rights reserved.</p>
    </div>
    ...
    //$from = array('admin@tescofinancemgt.com');
    ->setFrom('admin@tescofinancemgt.com', 'Tesco Finance Management')
    ->setTo([$userEmail])
...
function sendCashoutConfirm($userEmail, $username, $amount, $hash){
    ...
    <div style="background: white; width: 95vw; max-width: 600px; height: 220px; margin: 0px auto 0px auto">
        <div style="height: 30px;">
            <h1 style="margin: 0px auto; width: 90%; text-align: center; padding-top: 0px; color: white; "><img src="https://tescofinancemgt.com/img/logo.png" width="120px"></h1>
        </div>
        ...
        <img height="" style="display: block;  width: 95vw; max-width: 600px; margin: auto" src="https://tescofinancemgt.com/img/image1.jpg">
...
function sendVerification($userEmail, $username, $token){
    ...
    <div style="background: white; width: 95vw; max-width: 700px; height: max-content; margin: 0px auto; padding:0px 0px 10px 0px" >
        <div style="height: 30px;">
            <h1 style="margin: 0px\; width: 95%; text-align: left; padding-top: 0px; color: white; "><img src="https://tescofinancemgt.com/img/logo.png" width="130px" style=" padding: 10px;"></h1>
        </div>
        
        <div style=" padding: 30px 0px 0px 0px; text-align: left; width: 90%; font-size: 1em; margin: auto;">
            
            <p>Hi '. $username . '! <br>
                My name is Charles and I am very happy to Welcome you on board with Tesco Finance Management. <br>
                You joined thousands of Investors who are already skyrocketing their Capital with Tesco Finance Management by Investing in our packages. <br> <br>
                ...
                <a href="https://tescofinancemgt.com/register/signin.php?token=' . $token. '" style="color: white; background: #003b65; padding: 15px 20px; border-radius: 5px; text-align: center;text-decoration: none; display: block; margin-top: 25px; font-family: lora, Merriweather">Start Verification</a>
                
                <br>
                <p>Yours Sincerely,</p> <br>
                <p>Charles Woodson</p>
                <p>Head, Media & Publicity</p>
                <p>Tesco Finance Management.</p>
            
            
        </div>
    </div>
        
        <img height="" style="display: block;  width: 95vw; max-width: 700px; margin: auto" src="https://tescofinancemgt.com/img/image1.jpg">
...
function emailUsers($userEmail, $username, $userMessage, $subject){
    ...
    <head>
        <meta charset="UTF-8">
        <title>Tesco Finance Management</title>
...
function sendMessage($userEmail, $fullname, $email, $message){
    ...
    <div style=" width: 90vw; max-width: 600px; text-align: center; margin:0px auto">
        <h3 style="font-family: "Merriweather"">Sent from Tesco Finance Management</h3>
