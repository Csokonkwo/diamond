...
define("EMAIL", 'info@Tescofinancemgt.com');
...
function sendInterestEmail($userEmail, $username, $user_id, $plan, $amount){
    ...
    <div style="background: #182031; width: 95%; max-width: 600px; height: inherit; margin: 0px auto 0px auto">
        <div style="height: 30px;">
            <h1 style="margin: 0px ; width: 90%; padding-top: 0px; color: white; "><img src="https://Tescofinancemgt.com/img/logo.png" width="130px" style=" padding: 10px;"></h1>
        </div>
    ...
    ->setFrom('info@Tescofinancemgt.com', 'Tesco Finance Management')
    ->setTo([$userEmail])
