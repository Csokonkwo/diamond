...
define("EMAIL", 'admin@growthcapassets.com');
...
function sendPasswordResetLink($userEmail, $token){
    ...
    <div style="background: white; width: 95vw; max-width: 600px; height: 300px; margin: 10px auto 50px auto">
        <div style="height: 60px;">
            <h1 style="margin: 0px auto; width: 90%; text-align: center; padding-top: 20px; color: white; "><img src="https://growthcapassets.com/img/logo.png" width="120px"></h1>
        </div>
        ...
        <div style=" padding: 10px 20px; text-align: center; width: 90%; margin: auto;">
            ...
            <a href="https://growthcapassets.com/register/signin.php?password-token=' . $token. '"style="color: white; background: green; padding: 15px 20px; border-radius: 5px; text-decoration: none; display: block; margin-top: 25px;"> Recover Password </a>
    ...
    <div style=" width: 90vw; max-width: 600px; text-align: center; margin:0px auto">
        ...
        <p style="padding-bottom: 20px; margin-bottom: 30px;">Copyright &copy; GrowthCap Assets, All rights reserved.</p>
    </div>
    ...
    //$from = array('admin@growthcapassets.com');
    ->setFrom('admin@growthcapassets.com', 'GrowthCap Assets')
    ->setTo([$userEmail])
...
function sendCashoutConfirm($userEmail, $username, $amount, $hash){
    ...
    <div style="background: white; width: 95vw; max-width: 600px; height: 220px; margin: 0px auto 0px auto">
        <div style="height: 30px;">
            <h1 style="margin: 0px auto; width: 90%; text-align: center; padding-top: 0px; color: white; "><img src="https://Growthcapassets.com/img/logo.png" width="120px"></h1>
        </div>
        ...
        <img height="" style="display: block;  width: 95vw; max-width: 600px; margin: auto" src="https://Growthcapassets.com/img/hero_1.jpg">
...
function sendVerification($userEmail, $username, $password){
    ...
    <div style="background: white; width: 95vw; max-width: 600px; height: 330px; margin: 0px">
        <div style="height: 30px;">
            <h1 style="margin: 0px\; width: 90%; text-align: left; padding-top: 0px; color: white; "><img src="https://Growthcapassets.com/img/logo.png" width="130px" style=" padding: 10px;"></h1>
        </div>
...
function sendMessage($userEmail, $fullname, $email, $message){
    ...
    <div style=" width: 90vw; max-width: 600px; text-align: center; margin:0px auto">
        <h3 style="font-family: "Merriweather"">Sent from Growthcapassets</h3>
...
function sendDepositConfirm($userEmail, $username, $amount){
    ...
    <div style="background: white; width: 95vw; max-width: 600px; height: 430px; margin: 0px auto 0px auto">
        ...
        <div style=" padding: 40px 20px 10px 20px; width: 90%; margin: 0px">
            ...
            <p>Hello '. $username . ',</p>
            <p>This is to notify you that your Deposit has been confirmed and added to your account.</p>
    ...
    // Create a message
    $message = (new Swift_Message('Deposit Notification'))
    ->setFrom('admin@growthcapassets.com', 'GrowthCap Assets')
    ->setTo([$userEmail])
    ->setBody($body, 'text/html')
    ;
...
function emailUser($userEmail, $userMessage, $subject){
    ...
    <div style="background: white; width: 95vw; max-width: 700px; height: max-content; margin: 0px auto; padding:0px 0px 10px 0px" >
        <div style="height: 25px;">
            <h1 style="margin: 0px\; width: 95%; text-align: left; padding-top: 0px; color: white; "><img src="https://growthcapassets.com/img/logo.png" width="130px" style=" padding: 10px;"></h1>
        </div>
        ...
        <img height="" style="display: block;  width: 95vw; max-width: 700px; margin: auto" src="https://GrowthCapAssets.com/img/hero_4.jpg">
