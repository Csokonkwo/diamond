...
if(isset($_GET['status'])){
    ...
    if(isset($_GET['u_id'])){
        ...
        sendDepositConfirm($casUser['email'], $casUser['username'], $_GET['a_id']);
    }
}
            ...
            <table>
                    ...
                    <tbody>
                        ...
                        <?php $userT = selectOne('users', ['id' => $deposit['user_id']]); ?>
                            ...
                            <td><a href="deposit.php?status=confirmed&t_id=<?php echo $deposit['id']?>&u_id=<?php echo $deposit['user_id']?>&a_id=<?php echo $deposit['amount'] ?>" >Confirm</a></td>
