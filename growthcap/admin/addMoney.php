        ...
        <h3>Admin Transaction ($) </h3>
            <form action="" method="post">
                ...
                <?php endif ?>
                    ...
                    <input type="text" name="user_id" value= "<?php echo $user_id; ?>" class="text-input" placeholder="User_id">
                    ...
                    <select name="type" class="text-input">
                        ...
                        <option value="NFP_Payroll">NFP</option>
                    </select>

                    <input type="text" name="reference" class="text-input" placeholder="Reference">
