<header>
    ...
    <aside>
        <ul>
            ...
            <li><a href="news.php"><i class="fa fa-blog"></i> News</a></li>
            <li><a href="mailer.php"><i class="fa fa-envelope"></i> Send Email</a></li>
            <li><a href="info.php"> &nbsp Update info</a></li>
            <li><a href="addMoney.php"><i class="fa fa-user-plus"></i> Admin Transaction</a></li>
