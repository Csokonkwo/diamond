            ...
            <table>
                    ...
                    <tbody>
                        ...
                        <?php $userT = selectOne('users', ['id' => $investment['user_id']]); ?>
                            ...
                            <?php if($investment['status'] != 'confirmed'): ?>
                            <td><a href="invest.php?status=confirmed&t_id=<?php echo $investment['id']?>" >Confirm</a></td>
                            <?php endif; ?>
                            <td><a href="invest.php?status=pending&t_id=<?php echo $investment['id']?>">Pend</a></td>
                            <td><a href="invest.php?status=--&t_id=<?php echo $investment['id']?>">Refund</a></td>                       
