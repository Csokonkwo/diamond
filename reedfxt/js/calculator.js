...
function calculate(type){
    var packages = Array(basic,regular,standard);
...
function calcInv(){
    ...
    else if(package.value == 'standard'){
...
function showWallet(){
    ...
    if(method.value == 'etherium'){
        address.innerHTML = "Send Etherium to : <br> 0xbE0aB7aD8Dd5840bE1Cd090d43C36A20B3D4C4E4 <br> <br> "
    }

    if(method.value == 'bitcoin_cash'){
        address.innerHTML = "Send Bitcoin cash to : <br> qpvw64pg6tjj86a6gn35yxuznc9l6n8qcypqkzh6wt <br> <br> "
    }

    if(method.value == 'bitcoin'){
        address.innerHTML = "Send Bitcoin to : <br> bc1qagyqjt5207gt0mhqz2wr8m5jexq0e99da9w6ku <br> <br> "
    }
