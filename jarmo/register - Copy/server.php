    ...
    if (count($errors) === 0){
        ...
        if (count($errors) === 0){
            ...
            if($user_id == true){
                ...
                sendVerification($_POST['email'], $_POST['username']);
                //Flash message
        ...
        header("location: signin.php?signup=1&ref=$ref");
            exit();
    }
...
if(isset($_POST['update_profile'])){
    ...
    if(empty($_POST['wallet_id'])){
        $errors['wallet_id'] = "Enter your bitcoin wallet address";
    }

    $userDetail = selectOne('users', ['id'=> $_SESSION['id']]);

    if($userDetail['wallet_id']){
...
if(isset($_POST['forgot_password'])){
    ...
    if(count($errors) === 0){
        ...
        if(count($errors)===0){
            ...
            header('location: signin.php?password_message=1');
            exit(0);
        ...
        header("location: signin.php?forgot_password=1");
            exit();
    }
