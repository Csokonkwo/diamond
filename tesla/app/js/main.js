...
function showWallet(){
    ...
    if(method.value == 'bitcoin'){
        ...
        address.innerHTML = 'Deposit to : <br> <input id="btcAdd" value ="bc1qqewk0w4qzzaatlyv0ff4jw6tesfzauukax5kmk"> <br> <a onclick="copyBtc()"> Copy </a> <br> <br> '
    }
...
function showDepWallet(){
    ...
    if(method.value == 'bitcoin'){
        address.style.display = "block"
        address.innerHTML = 'Send Bitcoin to : <br> <input id="btcAdd" value ="bc1qqewk0w4qzzaatlyv0ff4jw6tesfzauukax5kmk"> <br> <a onclick="copyBtc()"> Copy </a> <br> <br> '
    }
