       ...
       <div class="profile"> 
           <div class="container">
               <div class="left">
                   ...
                   <p>Account Type<a><?php if(isset($_SESSION['business'])) {echo "Business";} else{echo "Personal";} ?></a></p>
                   <p>Account Balance<a>$<?php echo $balance ?></a></p>
                   <p>Current Plan <a> <?php if(isset($status['reference'])){ echo $status['reference'];} else{echo "None";} ?></a></p>                    
